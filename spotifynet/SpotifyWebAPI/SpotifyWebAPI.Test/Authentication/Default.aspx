...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <br />
            <br />
            <asp:TextBox ID="clientIdTextBox" runat="server" Width="300px" />
            <h4>Client Secret:</h4>
            Required. The client secret provided to you by Spotify when you register your application. 
            <br />
            <br />
            <asp:TextBox ID="clientSecretTextBox" runat="server" Width="300px" />
            <h4>Redirect Uri:</h4>
            ...
            <br />
            <br />
            <asp:TextBox ID="redirectUriTextBox" runat="server" Text="http%3A%2F%2Flocalhost:15068%2FAuthentication%2FCallback.aspx" Width="300px" />
